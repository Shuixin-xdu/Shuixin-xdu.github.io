...
<div class="character-detail-container">
    ...
    <div class="character-detail-info">
        <div class="character-header">
            <h1 class="character-title">Soyo狸</h1>
            <div class="character-tags">
                <span class="tag primary">Soyo系</span>
                <span class="tag secondary">犬科</span>
                <span class="tag accent">棉花生物</span>
                <span class="tag">灵巧型</span>
            </div>
        </div>
        ...
        <div class="quick-description">
            <h3>简介</h3>
            <p>优雅的亚麻棕棉花狐狸，MyGO!!!!!乐队的贝斯手......吗？外表机灵通常乖巧，会在受到威胁时缩为毛球。喜爱红茶与精致糕点，有着迷人的笑容与偶尔的恶作剧心态。经发现，因anon犬的传染，目前品种普遍会唐哭。</p>
        </div>
...
<div class="detail-sections">
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            <h3>饮食偏好</h3>
            <ul>
                <li><strong>最爱食物：</strong>蛋糕类的下午茶点心</li>
                <li><strong>常饮饮品：</strong>红茶</li>
                <li><strong>特殊习惯：</strong>喝茶时会将大尾巴优雅地卷在身侧</li>
            </ul>
            ...
            <div class="behavior-patterns">
                ...
                <div class="pattern-card">
                    ...
                    <div class="pattern-content">
                        <h4>音乐</h4>
                        <p>弹奏贝斯时全神贯注，动作流畅优美，与Soyo狸平时的表现不同，此时的它不引注意但情真意切，低音旋律中常透露出复杂的情感。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="detail-section">
        <h2>背景故事</h2>
        <div class="section-content">
            <p>Soyo狸最初被发现于月之森女子学园，因其优雅的举止和亚麻棕渐变毛色而备受瞩目。</p>
            ...
            <div class="timeline">
                <div class="timeline-item">
                    ...
                    <div class="timeline-content">
                        <h4>初次发现</h4>
                        <p>在月之森女子学园的周边被首次目击，缩成的毛球被清洁工当成垃圾捡起时突然惊起，两方都被吓了一跳。</p>
                    </div>
                </div>
                <div class="timeline-item">
        ...
        <div class="section-content">
            <div class="relationship-grid">
                <a href="../mutsumi_rabbit" class="relationship-card">
                    ...
                    <div class="rel-info">
                        <h4>Mutsumi兔</h4>
                        <p class="rel-type"><del>母女</del> 捕食</p>
                        <p class="rel-desc">Soyo狸会在野外尝试捕捉mutsumi兔，通常是捕而不食，但是会好奇地玩弄，比如<del>弄哭了再哄</del>试图取下mutsumi兔球状的兔尾巴和两个柔软地大垂耳。</p>
                    </div>
                </a>
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            <div class="anecdotes">
                <div class="anecdote">
                    <h4>🍰 萌系攻击</h4>
                    <p>曾因一家糕点店停售最爱的司康饼，连续三天在店外站立，用楚楚可怜的眼神，大眼睛泪汪汪地望着店主，最终店主不得不恢复供应并推出「Soyo特供司康」。</p>
                </div>
                <div class="anecdote">
                    <h4>请输入标题</h4>
                    <p>请输入文本</p>
...
[
    {
        id: 1,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/soyo_fox/setting_1.png",
        name: "设定名（例）",
        author: "作者名",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
        ...
        detail: 
            `
            <h4>角色背景</h4>
            <p>此设定描绘了Soyo狸在月之森女子学园时期的日常生活。亚麻棕的渐变毛发在阳光下显得格外柔和，大尾巴总是优雅地卷在身侧。</p>
            
            <h4>日常行为</h4>
            <ul>
                <li>喜爱坐在靠窗的位置，一边品尝红茶一边观察窗外</li>
                <li>保持优雅姿态，即使情绪波动也会迅速整理仪容</li>
            </ul>
            
            <h4>特殊习惯</h4>
            <p>当感到不安或遇到陌生人时，会本能地缩成毛球状，只有确认安全后才会慢慢展开。这个习惯有时会被误认为是某种防御机制，实际上更多是源于内心的敏感。</p>
    ...
    {
        id: 2,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/soyo_fox/setting_2.png",
        name: "设定名（例）",
        author: "作者名",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
        ...
        detail: 
            `
            <h4>习性</h4>
            <p>在野外状态下，Soyo狸展现出与学院时期完全不同的一面。动作更加敏捷，好奇心旺盛，经常在草原和洞穴间穿梭。</p>
            
            <h4>捕食行为</h4>
            <p>虽然是杂食性，但主要食物来源是各类浆果和根茎类植物。偶尔会尝试捕捉Mutsumi兔等小型生物，但通常只是出于玩耍而非捕食目的。</p>
