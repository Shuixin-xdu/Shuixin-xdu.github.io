...
<div class="character-detail-container">
    ...
    <div class="character-detail-image">
        <div class="fixed-image-section">
            <div class="main-image" onclick="openImageModal('main', this)">
                <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat.png" 
                     alt="Rana猫 主图" 
            ...
            <div class="thumbnail-gallery">
                <div class="thumbnail active" data-image="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat.png" data-signature="">
                    <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat.png" alt="主图">
                </div>
                <div class="thumbnail" data-image="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/pic1.png" data-signature="">
                    <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/pic1.png" alt="子图1">
                </div>
                <div class="thumbnail" data-image="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/pic2.png" data-signature="">
                    <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/pic2.png" alt="子图2">
                </div>
            </div>
        </div>
        ...
        <div class="gallery-card">
            ...
            <div class="gallery-image-container" onclick="openImageModal('gallery', this)">
                <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/others_1.png" 
                     alt="图集图片" 
                     id="galleryImage"
                     class="gallery-image">
    ...
    <div class="character-detail-info">
        <div class="character-header">
            <h1 class="character-title">Rana猫</h1>
            <div class="character-tags">
                <span class="tag primary">Rana系</span>
                <span class="tag secondary">猫科</span>
                <span class="tag accent">棉花生物</span>
                <span class="tag">灵动型</span>
            </div>
        </div>
        ...
        <div class="quick-description">
            <h3>简介</h3>
            <p>银白色异瞳棉花小猫，是MyGO!!!!!乐队的吉他手......吗？身法灵活，难以捉摸，但你有抹茶它就会跟你走。</p>
        </div>
...
<div class="detail-sections">
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            <h3>饮食偏好</h3>
            <ul>
                <li><strong>最爱食物：</strong>抹茶抹茶抹茶抹茶抹茶，荞麦面</li>
                <li><strong>常饮饮品：</strong>抹茶抹茶抹茶抹茶抹茶</li>
                <li><strong>特殊习惯：</strong>......，抹茶抹茶抹茶抹茶抹茶</li>
            </ul>
            ...
            <div class="behavior-patterns">
                <div class="pattern-card">
                    ...
                    <div class="pattern-content">
                        <h4>灵活の霓虹猫</h4>
                        <p>不可能的，一般情况下你不可能抓得到它的。什么，竟然用抹茶芭菲作为诱饵吗？！你这家伙...抓住了就要好好喂养哈🥺。<del>等等！你在干什么！你怎么忍心的！😭</del></p>
                    </div>
                </div>
                <div class="pattern-card">
                ...
                <div class="pattern-card">
                    ...
                    <div class="pattern-content">
                        <h4>音乐</h4>
                        <p>Rana猫喜爱音乐，喜爱演奏，早已与乐器为友为伴，弹奏吉他能力大幅高于Anon犬，“请输入文本”。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="detail-section">
        <h2>背景故事</h2>
        <div class="section-content">
            <p>Rana猫最初被发现于花咲川女子学园周边，起初是发现一堆猫围在一起，后来看到一个猫型的棉花娃娃状的身体站在中间，散播着猫食。它们听到观察者的动静立马都翻上围墙跑走了，小猫们，还有那只像猫娘的棉花娃娃...</p>
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            <div class="relationship-grid">
                <a href="../taki_wolf" class="relationship-card">
                    <div class="rel-avatar">
                        <img src="https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/taki_wolf.png" alt="Taki狼">
                    </div>
                    <div class="rel-info">
                        <h4>Taki狼</h4>
                        <p class="rel-type">长期饭票</p>
                        <p class="rel-desc">Rana猫四处游荡觅食，首次遇到Taki狼，在周围好奇地窜来窜去观察，不知为何Taki狼会递出食物，Rana猫自然笑纳后就逃走啦，之后每来一次都有东西吃，“你狼还怪好的嘞”。</p>
                    </div>
                </a>
                ...
                <a href="../tomori_penguin" class="relationship-card">
                    ...
                    <div class="rel-info">
                        <h4>Tomori企鹅</h4>
                        <p class="rel-type">解码员</p>
                        <p class="rel-desc">Tomori企鹅咕咕嘎嘎，大家都不知道是什么意思，不过都因这滑稽的样子笑得不能自己...Rana猫好像能听懂？！😨</p>
                    </div>
                </a>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const galleryImages = [
        {src: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/others_1.png", signature: "其它形象1(待署名)"}
    ];
...
[
    {
        id: 1,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/settings_1.png",
        name: "设定名（例）",
        author: "作者",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
    ...
    {
        id: 2,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/rana_cat/settings_2.png",
        name: "设定名（例）",
        author: "作者名",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
