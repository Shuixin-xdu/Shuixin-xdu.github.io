...
<div class="detail-sections">
            ...
            <div class="behavior-patterns">
                <div class="pattern-card">
                    ...
                    <div class="pattern-content">
                        <h4>唐笑</h4>
                        <p>当遇到开心事或吃到喜欢的水果三明治时，会突然发出响亮洗脑的笑声，耳朵和尾巴乖巧地摆动，让人想抽又不舍得抽。<del>当然也会有不少人舍得抽，狠狠抽！</del></p>
                    </div>
                </div>
                <div class="pattern-card">
                    <div class="pattern-icon">😭</div>
                    <div class="pattern-content">
                        <h4>唐哭</h4>
                        <p>情绪敏感，容易因<del>被人类欺负或虐██</del>各种原因突然哭泣。哭声与笑声一样洗脑至极，甚至对其它物种有一定模因影响。</p>
                    </div>
                </div>
                <div class="pattern-card">
                    ...
                    <div class="pattern-content">
                        <h4>拆家</h4>
                        <p>一部分Anon犬，它们被收养后自动触发破坏被动，这到底是后天形成的顽习还是刻在基因里的天性...总之，饲养者请妥善看管或教育，你也不想一觉醒来身处于火海或破烂堆之中吧。</p>
                    </div>
                </div>
                <div class="pattern-card">
                    <div class="pattern-icon">🎸</div>
                    <div class="pattern-content">
                        <h4>音乐</h4>
                        <p>经鞭策教育后，Anon犬手持吉他时进入专注状态，音乐<del>技术力待提高但</del>表现力强，可圈可点。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="detail-section">
        <h2>背景故事</h2>
        <div class="section-content">
            <p>Anon犬最初被发现于羽丘女子学园周边，是首次出现的棉花小生物，其有独特的棉花娃娃体型但却拥有自主行动能力，有一定智商。其固定的布质外表皮却有自由变化的表情，其棉花填充身体却能自主移动，还有莫名不知如何发出的令人受不了的笑声哭声...都引起研究者的关注。</p>
    ...
    <section class="detail-section">
        ...
        <div class="section-content">
            <div class="anecdotes">
                <div class="anecdote">
                    <h4>🍓 水果三明治</h4>
                    <p>曾有一次因为水果三明治售罄而情绪突然崩溃在店内大哭，差点把整个店拆光，导致店主紧急调货，从此该店常备奶油草莓三明治。</p>
                </div>
                <div class="anecdote">
                    <h4>请输入标题</h4>
                    <p>请输入文本</p>
...
<!-- 上面是html与markdown和yaml, 下面是css与js设定 -->
...
[
    {
        id: 1,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/anon_dog/settings_1.png",
        name: "设定名（例）",
        author: "作者",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
    ...
    {
        id: 2,
        image: "https://aidoll-1392936919.cos.ap-guangzhou.myqcloud.com/images/characters/anon_dog/settings_2.png",
        name: "设定名（例）",
        author: "作者名",
        authorLink: "此处放入社媒链接",
        platform: "bilibili",
